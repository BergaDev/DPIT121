...
public class ComprehensivePolicy extends InsurancePolicy {
  ...
  @Override
  public void print(){
    System.out.println("Policy Holder is: " + policyHolderName +  " Car type is: "  + super.car.type + " Car price is: " + super.car.price + " Driver age is: " + driverAge + " Level of policy is: " + level);
  }

  @Override
  public String toString(){
    return "Policy Holder is: " + policyHolderName +  " Car type is: "  + super.car.type + " Car price is: " + super.car.price + " Driver age is: " + driverAge + " Level of policy is: " + level;
  }
