...
public class Options {
  ...
  public static void menus(int choice, InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies) throws IOException{
...
public static void AdminMenu(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies) throws IOException{
  Scanner input = new Scanner(System.in);
  isAdmin = true;
    ...
    public static void UserMenu(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies, int userID) throws IOException{
      Boolean firstTime = true;
      System.out.println("");
      int option;
      Scanner input = new Scanner(System.in);
   ...
   //100% - inputMis
   public static void createUser(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies) throws IOException{
    //Working
    Scanner input = new Scanner(System.in);
  ...
  public static void mainMenu(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> insurancePolicies) throws IOException{
    Scanner input = new Scanner(System.in);
    System.out.println("");
  ...
  public static void createTPP(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies) throws IOException{
    Scanner input = new Scanner(System.in);
  ...
  //Includes inputMis
  public static void createTPP(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies, int userID) throws IOException{
    Scanner input = new Scanner(System.in);
    int thisUser = userID;
    double carPrice;
  ...
  //100% - inputMis
  public static void createCP(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies) throws IOException{
        Scanner input = new Scanner(System.in);
  ...
  //100% - inputMis
  public static void createCP(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies, int userID) throws IOException{
        Scanner input = new Scanner(System.in);
  ...
  //Wokring - inputMis
  public static void filterCarModel(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies) throws IOException{
    Scanner input = new Scanner(System.in);
   ...
   public static void filterCarModel(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies, int userID) throws IOException{
    Scanner input = new Scanner(System.in);
  ...
  //Working - inputMis
  public static void filterExpiryDate(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies) throws IOException{
    Scanner input = new Scanner(System.in);
    int option;
    int year, month, day;
...
//Working
   public static void filterExpiryDate(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies, int userID) throws IOException{
    Scanner input = new Scanner(System.in);
    int option;
    int year, month, day;
  ...
  //Working - inputMis
  public static void updateAddress(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies) throws IOException{
    Scanner input = new Scanner(System.in);
...
//inputMis
  public static void updateAddress(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies, int userID) throws IOException{
    Scanner input = new Scanner(System.in);
    int streetNum;
    String street, suburb, city;
    try {
  ...
  public static void outOfBounds(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies) throws IOException{
    Scanner input = new Scanner(System.in);
