...
public class ComprehensivePolicy extends InsurancePolicy {
  ...
  public ComprehensivePolicy (String policyHolderName, int id, Car car, int numberOfClaims,  int driverAge, int level, MyDate expiryDate) throws PolicyException, NameException{
