  ...
  String uPassword = "Admin";
   ...
   public static void createUser(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies) throws IOException, CloneNotSupportedException, PolicyException, NameException{
    ...
    if (uName.equals("Admin")){
      System.out.println();
      System.out.print("userName cannot be Admin, enter a new one: ");
      uName = input.nextLine();
    }
    }
    

    ArrayList<String> allUserNames = insuranceCompany.allUserNames("Admin", "Admin");
    for (String name: allUserNames){
      if (uName.equals(name)){
        System.out.println();
      System.out.print("userName already exists, enter a new one: ");
      uName = input.nextLine();
      }
    }
...
//inputMis
  ...
  public static void testCase(InsuranceCompany insuranceCompany, ArrayList<InsurancePolicy> policies) throws IOException, CloneNotSupportedException, PolicyException, NameException{
